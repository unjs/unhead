...
<header class="h-header u-border-gray-100 sticky top-0 z-10 w-full border-b bg-white/95 backdrop-blur dark:bg-black/95">
  <div class="container mx-auto flex items-center justify-between px-5 lg:px-20 lg:grid h-full grid-cols-12 lg:gap-8">
    <div class="col-span-3 flex flex-none items-center lg:flex-none">
      <NavbarDialog />
      <NavbarLogo class="hidden lg:block" />
    </div>

    <div class="col-span-6 flex flex-1 items-center justify-center">
      <NavbarLogo class="lg:hidden" />
      <NavbarCenter class="hidden lg:flex" />
    </div>

    <div class="col-span-3 flex flex-none items-center justify-end lg:gap-4 lg:pl-4">
      <GithubButton class="hidden xl:inline h-[20px]" href="https://github.com/unjs/unhead" :data-color-scheme="githubColorScheme" data-icon="octicon-star" data-show-count="true" aria-label="Star unhead on GitHub">
        Star
      </GithubButton>
