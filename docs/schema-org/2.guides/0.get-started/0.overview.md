...
Use a [custom node](/docs/schema-org/guides/recipes/custom-nodes) with [`schema-dts`](https://github.com/google/schema-dts) when you need autocomplete for the full Schema.org vocabulary.
