...
Vite does not add it to production builds. Default production builds pay no classification cost.

Add a focused server instance when a framework owns head creation or you call `createStreamableHead()`:
