...
[`ValidatePlugin`](/docs/typescript/head/guides/tooling/validate-plugin) reports these tags during development as `streamed-tag-hidden-from-bots`. Vite adds the full validator to development server heads made by `createHead()`.
