---
title: Upgrade Guide
description: Learn how to migrate between Unhead versions for Svelte users.
navigation:
  title: Upgrade Guide
---
...
The `mode` option on head entries has been removed. Use SvelteKit's environment detection instead:
