...
// 2. Stream Vue content (HeadStream components are auto-injected by Vite plugin)
...
That's it! The Vite plugin injects `HeadStream`{lang="ts"} components into your templates, which emit head updates as suspense boundaries resolve.
