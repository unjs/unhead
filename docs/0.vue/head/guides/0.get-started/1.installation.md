...
Remove `@vueuse/head` when moving to `@unhead/vue`. If both packages remain installed, Unhead v1 can stay in the lockfile and auto-imports may still point to the old composables.
