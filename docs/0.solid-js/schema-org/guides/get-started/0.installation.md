...
If you're using Vite, the [Vite plugin](/docs/head/guides/advanced/vite-plugin) will automatically strip schema-org from your client bundle and optimize your head tags at build time:
