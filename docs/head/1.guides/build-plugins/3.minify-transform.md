...
description: Transpile and optionally minify static inline script and style content inside useHead() calls at build time.
...
build time. Dynamic strings remain unchanged.
