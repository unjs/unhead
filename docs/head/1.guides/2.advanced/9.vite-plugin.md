...
- Pre-minify static inline script/style content inside `useHead()` calls at build time
...
| `minify` | `boolean \| object` | `true` | Pre-minify static inline script/style content. See [Minify Plugin](/docs/head/guides/plugins/minify#build-time-minification) |
