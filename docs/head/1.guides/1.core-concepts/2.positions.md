...
::note
Under [streaming SSR](/docs/typescript/head/guides/core-concepts/streaming), `bodyOpen` falls back to the body close for a tag registered after the shell flushes.
::
