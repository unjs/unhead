...
description: 'Add Schema.org to Angular apps with @unhead/schema-org. Setup defineWebSite(), defineWebPage() for Google Rich Results.'
navigation:
  title: 'Installation'
---
...
If you're using Vite, the [Vite plugin](/docs/head/guides/advanced/vite-plugin) will automatically strip schema-org from your client bundle and optimize your head tags at build time. See the [Vite Plugin guide](/docs/head/guides/advanced/vite-plugin) for framework-specific setup.
