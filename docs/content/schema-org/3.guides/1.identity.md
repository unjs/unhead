...
Using `defineOrganization` or `SchemaOrgOrganization` by default will set your identity to an [Organization](/schema-org/schema/organization).
...
Using `definePerson` or `SchemaOrgPerson` by default will set your identity to a [Person](/schema-org/schema/person).
...
Using `defineLocalBusiness` or `SchemaOrgLocalBusiness` by default will set your identity to a [LocalBusiness](/schema-org/schema/local-business).
...
[Articles](/schema-org/schema/article)

- publisher is the identity
- authored by the identity

[Product](/schema-org/schema/product)
...
[WebSite](/schema-org/schema/website)
