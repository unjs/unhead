...
export default defineBuildConfig({
  ...
  entries: [
    ...
    { input: 'src/v4/server-plans', name: 'v4/server-plans' },
    { input: 'src/v4/client', name: 'v4/client' },
    { input: 'src/v4/client-compiled', name: 'v4/client-compiled' },
    { input: 'src/v4/client-plans', name: 'v4/client-plans' },
    { input: 'src/v4/identity', name: 'v4/identity' },
    { input: 'src/v4/compile', name: 'v4/compile' },
