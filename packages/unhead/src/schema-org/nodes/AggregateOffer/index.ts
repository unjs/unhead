...
import { asArray, defineSchemaOrgResolver, resolveRelation, setIfEmpty } from '../../util'
...
export const aggregateOfferResolver = /* @__PURE__ */ defineSchemaOrgResolver<AggregateOffer>({
  defaults: {
    '@type': 'AggregateOffer',
  },
  inheritMeta: [
