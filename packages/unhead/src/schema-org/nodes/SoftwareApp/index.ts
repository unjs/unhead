...
import { defineSchemaOrgResolver, resolveDefaultType, resolveRelation } from '../../util'
...
export const softwareAppResolver = /* @__PURE__ */ defineSchemaOrgResolver<SoftwareApp>({
  defaults: {
