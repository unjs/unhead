...
describe('vue dom useHeadSafe', () => {
  it('basic', async () => {
    ...
    expect(dom.serialize()).toMatchInlineSnapshot(`
      ...
      <meta charset="utf-8"><link href="https://cdn.example.com/favicon.ico" rel="icon" type="image/x-icon"><link data-bar="foo" href="/valid.png" rel="icon"><link href="alert(1)" rel="icon"><link data-bar="foo" href="https://cdn.example.com/style.css" rel="stylesheet"><style data-foo="bar"></style></head>
