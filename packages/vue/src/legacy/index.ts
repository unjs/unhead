...
import { DeprecationsPlugin, FlatMetaPlugin, PromisesPlugin } from 'unhead/plugins'
import { SafeInputPlugin } from 'unhead/plugins/safe'
...
export function CapoPlugin() {
  return defineHeadPlugin((head) => {
    head.resolvedOptions.disableCapoSorting = false
    return {
      key: 'capo',
    }
  })
