...
export interface UseScriptOptions<T extends Record<symbol | string, any> = Record<string, any>, U = Record<string, any>> extends HeadEntryOptions, Pick<BaseUseScriptOptions<T, U>, 'use' | 'stub' | 'eventContext' | 'beforeInit'> {
  /**
