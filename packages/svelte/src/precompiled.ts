...
export type PrecompiledSvelteHead = PrecompiledClientHead | PrecompiledServerHead

function uncompiled(): never {
  throw new Error('[unhead] @unhead/svelte/precompiled calls must be compiled by @unhead/bundler')
}
