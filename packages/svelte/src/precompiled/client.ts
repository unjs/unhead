...
export function useHead(input: ResolvableHead, options: { bindings?: readonly (() => unknown)[], head: PrecompiledClientHead }): void {
...
export const useSeoMeta = useHead as (input: UseSeoMetaInput, options: { bindings?: readonly (() => unknown)[], head: PrecompiledClientHead }) => void
