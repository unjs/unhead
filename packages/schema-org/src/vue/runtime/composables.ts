...
export function defineDiscussionForumPosting<Input extends object | undefined = undefined>(input?: VueSchemaOrgDefinerInput<DiscussionForumPosting, Input>) {
  return provideResolver(input, discussionForumPostingResolver)
}
export function defineEmployerAggregateRating<Input extends object | undefined = undefined>(input?: VueSchemaOrgDefinerInput<EmployerAggregateRating, Input>) {
...
export function defineMathSolver<Input extends object | undefined = undefined>(input?: VueSchemaOrgDefinerInput<MathSolver, Input>) {
...
export function defineQuiz<Input extends object | undefined = undefined>(input?: VueSchemaOrgDefinerInput<Quiz, Input>) {
...
export function defineVacationRental<Input extends object | undefined = undefined>(input?: VueSchemaOrgDefinerInput<VacationRental, Input>) {
